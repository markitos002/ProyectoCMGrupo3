...
<html>
    ...
    <body>
        <%
            ...
            tipoCita.setIdTipoCita(0);
            tipoCita.setNombre("");
        %>
    <center>
        <form action="ControlTipoCita">
            <br>
            <h5><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tipo de Cita Médica Consulta</strong></h5>
            ...
            <table class="table table-sm" style="width: 88%">
                <thead class="table-dark table-sm">
                    <div class="col">
                        <td style="width: 94%;"><strong>Nombre</strong></td>
                    </div> 
                    <div class="col">
                        <td style="width: 6%;">&nbsp;&nbsp;</td>
                    </div>
                ...
                <tbody>
                    <tr>                        
                        <div class="col">
                           <td colspan="2">
                                <div class="col-12"> 
                                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="" autofocus="yes">
                                </div>
