                                ...
                                if(horarios.size()>0){
                                    for(int i=0;i<horarios.size();i++){ 
                                        ...
                                        if( horarioDia.getIdHorarioCitasDia()==citas.getIdHorarioCitas()) { %>
                                            <option value="<%= horarioDia.getIdHorarioCitasDia()%>" selected ><%= horarioDia.getInicio()%></option>
                                    <% } else { %>
                                        <option value="<%= horarioDia.getIdHorarioCitasDia()%>"><%= horarioDia.getInicio()%></option>
                                    <% } 
                                    }
                                }%>
                        </select>
