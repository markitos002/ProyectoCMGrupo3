...
public List listarConParametro(String parametro) {
    ...
    String sql = "SELECT E.ESME_NOMBRE, P.PERS_ID, CONCAT(P.PERS_PRIMERAPELLIDO, ' ', P.PERS_SEGUNDOAPELLIDO, ' ', P.PERS_PRIMERNOMBRE, ' ', P.PERS_SEGUNDONOMBRE ) NOMBRE " 
            + "FROM APPCONSULTAS.MEDICO M, APPCONSULTAS.PERSONA P, APPCONSULTAS.ESPECIALIDADESMEDICAS E, "
            + "APPCONSULTAS.ESPECIALIDADPORMEDICO E2 " 
            + "where M.PERS_ID = P.PERS_ID AND M.PERS_ID = E2.PERS_ID AND E2.ESME_ID = E.ESME_ID AND E2.ESME_ID = ? ";
