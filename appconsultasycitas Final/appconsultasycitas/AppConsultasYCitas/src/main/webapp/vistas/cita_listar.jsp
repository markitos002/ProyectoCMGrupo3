...
<%
    ...
    //JOptionPane.showMessageDialog(null, paginador+" "+totalPags, "Resultado de la Operación", JOptionPane.ERROR_MESSAGE);
    if(paginador==null){
        paginador = "1";
    }
...
<form name ="form1" action="ControlCita">
  <h5><strong>             Citas</strong></h5>
    <table style="width: 90%">
      <tr>
        <td style="width: 7%;"> 
            <a href="ControlCita?accion=volver" class="btn btn-primary btn-sm"> <strong>Volver</strong></a> 
        </td>
        ...
        <div class="col">
            <td colspan="6" style="width: 100%;"><p class="fs-6 text-center" style="background-color: #C4E3FB; height: 2rem;"><strong>Listado de Citas</strong></p></td>
        </div>
    </table>
</form>
    <table class="table table-sm" style="width: 90%">
        <thead class="table-dark table-sm">
                            <tr class="">
                              ...
                              <td width="12%" align="left" class=""><strong>Tipo Cita</strong></td>
