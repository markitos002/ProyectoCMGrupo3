...
<form name ="form1" action="ControlReceta">
  <h5><strong>             Receta</strong></h5>
    <table style="width: 90%">
      <tr>
        <td style="width: 7%;"> 
            <a href="ControlReceta?accion=volver" class="btn btn-primary btn-sm"> <strong>Volver</strong></a> 
        </td>
        ...
        <div class="col">
            <td colspan="6" style="width: 100%;"><p class="fs-6 text-center" style="background-color: #C4E3FB; height: 2rem;"><strong>Listado de Receta</strong></p></td>
        </div>
    </table>
</form>
