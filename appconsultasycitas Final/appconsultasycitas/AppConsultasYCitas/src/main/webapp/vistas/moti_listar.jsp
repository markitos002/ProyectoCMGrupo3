        ...
        <center>
            ...
            <form  action="ControlMotivo" name="forma01" id="forma01">
                ...
                <table class="table table-sm" style="width: 86%">
                    <tr>
                        <td style="width: 7%;"> 
                            <a href="ControlMotivo?accion=volver" class="btn btn-primary btn-sm"> <strong>Volver</strong></a> 
                        </td>
                        <td style="width: 13%;"> 
                            Página
                        ...
                        <div class="col">
                            <td colspan="6" style="width: 100%;"><p class="fs-6 text-center" style="background-color: #C4E3FB; height: 2rem;"><strong>Listado de Motivos de Consulta</strong></p></td>
                        </div> 
