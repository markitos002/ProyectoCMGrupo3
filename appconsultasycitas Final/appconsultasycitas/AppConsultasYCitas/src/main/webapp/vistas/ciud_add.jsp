...
<%
    ...
    listaDepartamentos = (ArrayList)departamentoDAO.listar();

    if(request.getParameter("nombre")==null){
        ciudad.setNombre("");
    }else{
        ciudad.setNombre((String)request.getParameter("nombre"));
    }
    
    if(request.getParameter("idDepartamento")==null){
        ciudad.setIdDepartamento(0);
    }else{
        ciudad.setIdDepartamento(Integer.parseInt(request.getParameter("idDepartamento")));
    }
    ...
    <table style="width: 90%">
      <tr>
        <td style="width: 6%;" valign="top" >
          <a href="ControlCiudad?accion=Buscar&parametro=<%=parametro%>&paginador=<%=paginador%>&valor=0" class="btn btn-primary btn-sm"> <strong>Volver</strong></a>
        </td>
    ...
    <table style="width: 90%">
        ...
        <tr>
            <td>
                <div class="row g-6" >
                    <div class="col-md-8">
                        <label for="nombre" class="form-label"><strong>Nombre Ciudad</strong></label>
                        <input name="nombre" id="nombre" value="<%= ciudad.getNombre() %>" type="text" class="form-control" size="50" maxlength="50">
                    </div>

                    <div class="col-md-4">
                        <label for="idDepartamento" class="form-label"><strong>Departamento</strong></label>
        ...
        <input name="usuario" id="usuario" value="<%= ciudad.getRegistradoPor()%>" type="hidden" class="form-control" size="50" maxlength="100">               
    </table>
    <br>
