...
<%
    ...
    if(identif!=null){
        if(!(identif.equals(""))&& (!identif.equals("0"))&&!(identif==null)){
            ...
            citas.setFechaCambio(String.valueOf(java.sql.Date.valueOf(java.time.LocalDate.now())));
                ...
                if(horarios.size()>0){
                    for(int i=0;i<horarios.size();i++){ 
                        ...
                        if( horario.getIdHorarioCitasDia() == Integer.parseInt(request.getParameter("horario"))){     
                            ...
                            citas.setHora(horarios.get(i).getHora());
    ...
    <table style="width: 90%">
      <tr>
        <td style="width: 100%;" align="left">
            ...
            <input type="hidden" class="form-control" name="accion2" id="accion2" value="add" size="10" maxlength="10">
            <input type="hidden" class="form-control" name="idPersona" id="idPersona" value="<%=citas.getIdPaciente()%>" size="10" maxlength="10">
        </td>
      </tr>
    </table>
    <table style="width: 90%">
            ...
            <td>
                <div class="row g-6" >
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="idEspecialidad" name="idEspecialidad" class="form-select" onchange="submit()">
            ...
            <td>
                <div class="row g-6" >
                    ...
                    <div class="col-md-4">
                        ...
                        <input name="hora" id="hora" value="<%= citas.getHora()%>" type="hidden" class="form-control" size="50" maxlength="100">               
                    </div>
                </div>
            </td>
        </tr>
    ...
    <table width="90%" border="0" cellspacing="1" cellpadding="2">
      <tr>
            ...
            <td style="width: 6%;" valign="top"> 
                <input type="submit" name="accion" id="accion" value="Grabar" class="btn btn-primary btn-sm">
            </td>
      </tr>
    </table>
    </center>
