...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
    ...
    <body>
                     <% 
                        ...
                        List<TipoCita> list = new ArrayList<>();
        ...
        <center>
            ...
            <form  action="ControlTipoCita" name="forma01" id="forma01">
                ...
                <table class="table table-sm" style="width: 86%">
                    <tr>
                        <td style="width: 7%;"> 
                            <a href="ControlTipoCita?accion=volver" class="btn btn-primary btn-sm"> <strong>Volver</strong></a> 
                        </td>
                        <td style="width: 13%;"> 
                            Página
                            <select class="custom-select custom-select-lg mb-3" id="paginador" name="paginador" onchange="submit('ControlTipoCita?accion=Buscar')">
                            <%		
                        ...
                        <td style="width: 20%;" align="right"> 
                            <a href="ControlTipoCita?accion=add&parametro=<%=parametro%>&paginador=<%=paginador%>" class="btn btn-primary btn-sm"> <strong>Adicionar Registro</strong></a>
                        </td>
                    </tr>

                        <div class="col">
                            <td colspan="6" style="width: 100%;"><p class="fs-6 text-center" style="background-color: #C4E3FB; height: 2rem;"><strong>Listado de Tipos de Citas Médicas</strong></p></td>
                        </div> 
            ...
            <table class="table table-sm" style="width: 86%">
                ...
                <tbody>
                    ...
                    <% 
                        ...
                        Iterator<TipoCita> iter = list.iterator();
                    ...
                    <tbody>
                        <tr>                        
                            <div class="col">
                                <td style="width: 10%;"><%= tipoCita.getIdTipoCita()%> &nbsp;&nbsp;</td>
                            </div>
                           <div class="col">
                                <td style="width: 75%;"><%= tipoCita.getNombre()%> &nbsp;&nbsp;</td>
                            </div>
                            <div class="col">
                                <td style=" width: 15%;" align="right">
                                    <a href="ControlTipoCita?accion=edit&id=<%= tipoCita.getIdTipoCita()%>&parametro=<%= parametro%>&paginador=<%= paginador%>" class="btn btn-primary btn-sm"><strong>Editar</strong></a>
                                    <a href="ControlTipoCita?accion=eliminar&id=<%= tipoCita.getIdTipoCita()%>&parametro=<%= parametro%>&paginador=<%= paginador%>" class="btn btn-danger btn-sm"><strong>Eliminar</strong></a>
                                </td>
                            </div>     
                        </tr>
                        <%}%>
