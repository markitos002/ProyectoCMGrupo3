    ...
    <table class="table table-sm" style="width: 90%">
        <thead class="table-dark table-sm">
                            <tr class="">
                                ...
                                <td width="7%" align="center"><strong>Id Paciente</strong></td>
                                <td width="13%" align="center"><strong>Paciente</strong></td>
                                <td width="7%" align="center"><strong>Id Medico</strong></td>
                                <td width="13%" align="center"><strong>Medico</strong></td>
                                <td width="15%" align="center"><strong>Motivo Consulta</strong></td>
                                <td width="20%" align="center"><strong>Diagnostico</strong></td>
                                <td width="5%" align="center"><strong>Id Cita</strong></td>
