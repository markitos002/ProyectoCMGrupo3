...
<body>
<form name ="form1" action="ControlConsulta">
    <center>
  <h5><strong>             Consulta Médica</strong></h5>
    ...
    <table width="90%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <td width="85%" height="20" align="left"><input name="idConsultaMedica" value="<%= consultaMedica.getIdConsultaMedica() %>" type="text" class="form-control" size="20" maxlength="100"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="85%" height="20" align="left"><input name="idCita" value="<%= consultaMedica.getIdCita() %>" type="text" class="form-control" size="20" maxlength="100"></td>
      </tr>
      <tr>
        <td width="15%" align="left" class="text_negro">Id Paciente</td>
        <td width="85%" height="20" align="left"><input name="idPaciente" value="<%= consultaMedica.getIdPaciente() %>" type="text" class="form-control" size="20" maxlength="100"></td>
      </tr>
      <tr>
        <td width="15%" align="left" class="text_negro">Id Medico</td>
        <td width="85%" height="20" align="left"><input name="idMedico" value="<%= consultaMedica.getIdMedico() %>" type="text" class="form-control" size="20" maxlength="100"></td>
      </tr>
      <tr>
        <td width="15%" align="left" class="text_negro">Id Motivo Consulta</td>
        <td width="85%" height="20" align="left"><input name="idMotivoConsulta" value="<%= consultaMedica.getIdMotivoConsulta() %>" type="text" class="form-control" size="20" maxlength="100"></td>
      </tr>
