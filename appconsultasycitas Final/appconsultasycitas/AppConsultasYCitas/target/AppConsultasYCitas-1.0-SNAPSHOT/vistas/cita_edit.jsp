...
<%
    ...
    if((request.getParameter("idPaciente") != null)&&(request.getParameter("idPaciente") != "")){
    ...
    for(int i=0;i<listaPacientes.size();i++){ 
        ...
        if (String.valueOf(paciente1.getPers_id()) == (String)request.getParameter("idPaciente")){     
            citas.setIdPaciente(Integer.parseInt(request.getParameter("idPaciente")));
            citas.setPaciente(paciente1.getNombre()); 
        } 
    }
    ...
    /*if(request.getParameter("idMedico") != null){
        citas.setIdMedico(Integer.parseInt( String.valueOf(request.getParameter("idMedico"))));
    }*/

    for(int i=0;i<listaMedicos.size();i++){ 
        medico1 = (Medico)listaMedicos.get(i);

        if (String.valueOf(medico1.getIdPers()) == (String)request.getParameter("idMedico")){     
            citas.setIdMedico(Integer.parseInt(request.getParameter("idMedico")));
            citas.setPaciente(medico1.getNombre()); 
        } 
    }
...
function recargar2(frm){
    ...
    <%for(int i=0;i<listaMedicos.size();i++){ 
        medico1 = (Medico)listaMedicos.get(i);
    %>
     if (frm.idMedico.value == <%=medico1.getIdPers()%>){     
        frm.medico.value = "<%= medico1.getNombre()%>";
     }
  <%}%>  
}
...
<form id="form1" action="ControlCita">
  ...
  <h5><strong>             Citas</strong></h5>
            ...
            <td>
                <div class="row g-6" >
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="motivoConsulta" id="motivoConsulta" value="<%= citas.getMotivoDeConsulta() %>" size="100" maxlength="200" onchange="javascript:validar(document.forms['form1']);">
                    </div>      
                </div>
            </td>
        </tr>    
    ...
    <table width="90%" border="0" cellspacing="1" cellpadding="2">
      ...
      <input type="hidden" name="id" id="id" maxlength="5" value="<%=citas.getIdCitas()%>">
    </table>
    <table width="90%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        <div class="col">
