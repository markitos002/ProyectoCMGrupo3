                ...
                <td>
                    <div class="row g-6">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="hidden" class="form-control" id="idPersona" name="idPersona" aize="15" maxlength="15" >
                          <input type="hidden" class="form-control" id="paginaInicio" name="paginaInicio" aize="100" maxlength="100" >
                       </div>
                        <div class="col-md-3">
                            &nbsp;
                        </div>
