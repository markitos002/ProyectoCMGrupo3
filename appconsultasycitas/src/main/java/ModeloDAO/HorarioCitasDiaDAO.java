...
public List listarConParametro(String parametro) {
    ...
    String sql = "SELECT * FROM "
            ...
            + "CONCAT(H.HOAT_HORAFIN,H.HOAT_MINUTOFIN) FIN, M.CONS_ID, C.CONS_NOMBRE CONSULTORIO,   " 
            ...
            + "(SELECT HOCI_ID, CONCAT(HOCI_HORAINICIO,HOCI_MINUTOINICIO) HI, CONCAT(HOCI_HORAFIN,HOCI_MINUTOFIN) HF FROM APPCONSULTAS.HORARIOCITASDIA H) B  "
